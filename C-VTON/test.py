...
from dataloaders.DresscodeDataset import DresscodeDataset
...
if opt.phase == "test":
    ...
    for i, data_i in enumerate(test_dataloader):
        ...
        if opt.dataset == "mpv":
            ...
            filename = data_i['name'][0].split("/")[-1].replace(".jpg", "") + "test" + data_i['cloth_name'][0].split("/")[-1]
