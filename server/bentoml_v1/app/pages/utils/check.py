...
def check_dress():
    ...
    st.session_state.lower_long, st.session_state.lower_short, st.session_state.lower_etc = 0, 0, 0
...
def check_lower_long():
    st.session_state.lower_long, st.session_state.lower_short, st.session_state.lower_etc = 1, 0, 0
def check_lower_short():
    st.session_state.lower_long, st.session_state.lower_short, st.session_state.lower_etc = 0, 1, 0
def check_lower_etc():
    st.session_state.lower_long, st.session_state.lower_short, st.session_state.lower_etc = 0, 0, 1
